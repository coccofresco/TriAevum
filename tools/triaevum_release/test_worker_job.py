...
@unittest.skipUnless(os.name == "nt" or sys.platform.startswith("linux"), "Windows/Linux worker lifecycle")
class WorkerJobTests(unittest.TestCase):
    ...
    @unittest.skipUnless(os.name == "nt", "Windows descendant Job Object")
