...
class ForgeTests(unittest.TestCase):
    ...
    def prepare_legacy_installation(self):
        ...
        exe, plugin = self.root / platforms.host().runtime, self.root / platforms.host().plugin
    ...
    def test_migration_is_idempotent_preserves_saves_and_can_move(self):
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            validate_installed_runtime(moved / platforms.host().runtime, new_title, moved / "forge-output", runtime)
