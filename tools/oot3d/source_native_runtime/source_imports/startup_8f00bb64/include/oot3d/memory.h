...
/*
 * Target-side pointers are always 32-bit. This partial layout is used only by
 * the small wrapper at 0x00343270.
 */
...
void* oot3d_memcpy_aligned_end(
    void* destination,
    const void* source,
    size_t size
);
void* oot3d_memcpy_end(
    void* destination,
    const void* source,
    size_t size
);
