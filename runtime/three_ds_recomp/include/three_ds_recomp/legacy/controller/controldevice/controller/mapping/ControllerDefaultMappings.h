 ...
 *
 * ThreeDsRecomp::Legacy::ControllerDefaultMappings is the concrete ControllerDefaultMappings
 ...
 *
 * Pass an instance to ThreeDsRecomp::Legacy::ControlDeck (or Ship::ControlDeck) to customise the
