...
#include <vector>
#include <map>
#include "three_ds_recomp/legacy/libultra/controller.h"
 ...
 *
 * ThreeDsRecomp::Legacy::Controller is the concrete Controller subclass used by libultraship. It
 ...
 *
 * Instances are created automatically by ThreeDsRecomp::Legacy::ControlDeck when a port is configured;
