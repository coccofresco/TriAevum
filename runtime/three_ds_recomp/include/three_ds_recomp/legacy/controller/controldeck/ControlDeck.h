 ...
 *
 * ThreeDsRecomp::Legacy::ControlDeck is the concrete ControlDeck subclass used by libultraship. It
 ...
 *
 * Obtain the instance from Context::GetControlDeck(), cast to ThreeDsRecomp::Legacy::ControlDeck if
