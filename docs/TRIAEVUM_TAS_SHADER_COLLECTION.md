...
The resulting corpus is now connected to private Windows Forge and the installed
Linux Flatpak: see [activation and measured reuse](TRIAEVUM_TAS_CORPUS_ACTIVATION.md).
